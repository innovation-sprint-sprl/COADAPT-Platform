...
namespace UserManagement.WebAPI.Controllers {
	...
	public class AppUsageLogController : ControllerBase {
		...
		private async Task LogFailedAppUsageCreation(AppUsageLogRequest appUsageLogRequest) {
			AppUsageLog appUsageLog = new AppUsageLog { Message = $"Failed app usage log creation", Tag = "AppUsageLogController-CreateAppUsageLog", UserId = appUsageLogRequest.UserId, ReportedOn = DateTime.Now };
			_coadaptService.AppUsageLog.CreateAppUsageLog(appUsageLog);
			await _coadaptService.SaveAsync();
		}
